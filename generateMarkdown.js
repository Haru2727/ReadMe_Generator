...
function generateMarkdown({ title, description, installation, usage, tribute, badges, email, github,test }) {
  return `
...
## License
  ...
  This application uses the ${badges} license, click on the badge to see the legal notice.  
